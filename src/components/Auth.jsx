    ...
    <div className="flex flex-col items-center justify-center h-screen px-6 gap-6">
      ...
      <div className="w-full flex flex-col gap-3">
        <div className="bg-bg-surface border border-border rounded-lg p-4">
          <p className="text-xs text-text-muted mb-3">Sign in on the web app first, then return here to clip content.</p>
          <a 
            href="https://annotated-2ec.pages.dev/" 
            target="_blank"
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-bg-base px-2 text-text-muted">or sign in directly</span>
          </div>
        </div>
        ...
        <button 
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-bg-surface border border-border rounded-lg py-3 px-4 text-sm font-medium text-text-primary hover:bg-bg-raised transition-colors disabled:opacity-50"
        >
          <GoogleIcon />
...
function GoogleIcon() {
  return <svg width="18" height="18" viewBox="0 0 18 18">
    ...
    <path d="M3.964 10.705A5.41 5.41 0 0 1 3.682 9c0-.593.102-1.17.282-1.705V4.963H.957A9.005 9.005 0 0 0 0 9c0 1.452.348 2.827.957 4.037l3.007-2.332z" fill="#FBBC05"/>
    <path d="M9 3.583c1.321 0 2.508.454 3.44 1.345l2.582-2.58C13.463.891 11.426 0 9 0 5.482 0 2.438 2.017.957 4.963L3.964 7.295C4.672 5.169 6.656 3.583 9 3.583z" fill="#EA4335"/>
  </svg>;
}
